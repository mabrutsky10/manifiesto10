            ...
            <div className="mt-8 grid gap-8 md:grid-cols-3">
              ...
              <div className="rounded-2xl border border-primary-200 bg-primary-50 p-5 hover:bg-primary-100 hover:shadow-md transition-all">
                ...
                <ul className="mt-3 space-y-2 text-xs text-gray-700 md:text-sm">
                  <li className="flex items-start gap-2">
                    <span className="text-primary-600 mt-1 font-bold">•</span>
                    <span>Perfiles de equipos y jugadores con estadísticas.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary-600 mt-1 font-bold">•</span>
                    <span>Gol Popular: entrevistas, notas y coberturas.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary-600 mt-1 font-bold">•</span>
              ...
              <div className="rounded-2xl border border-primary-200 bg-primary-50 p-5 hover:bg-primary-100 hover:shadow-md transition-all">
                ...
                <ul className="mt-3 space-y-2 text-xs text-gray-700 md:text-sm">
                  <li className="flex items-start gap-2">
                    <span className="text-primary-600 mt-1 font-bold">•</span>
                    <span>Radar +10: mapa vivo de equipos, jugadores y canchas.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary-600 mt-1 font-bold">•</span>
                    <span>Mercado de Pases: conexión entre jugadores y clubes.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary-600 mt-1 font-bold">•</span>
                    <span>ProTorneos y +Trainer: gestión y desarrollo deportivo.</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-2xl border border-primary-200 bg-primary-50 p-5 hover:bg-primary-100 hover:shadow-md transition-all">
                ...
                <ul className="mt-3 space-y-2 text-xs text-gray-700 md:text-sm">
                  <li className="flex items-start gap-2">
                    <span className="text-primary-600 mt-1 font-bold">•</span>
                    <span>Socios Coquita: aporte mensual simbólico de hinchas.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary-600 mt-1 font-bold">•</span>
                    <span>Sponsors de cercanía: marcas y comercios barriales.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary-600 mt-1 font-bold">•</span>
                    <span>Activaciones y prodes comunitarios para financiar la pasión.</span>
                  </li>
                </ul>
              </div>
            </div>
